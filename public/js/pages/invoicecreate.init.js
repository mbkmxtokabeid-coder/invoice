        ...
        Array.from(paroducts_list).forEach(function (e) {
          (document.getElementById("productName-" + counter_1).value =
            ...
            (document.getElementById(
              "productDetails-" + counter_1
            ).value = e.product_details),
            (document.getElementById(
              "productRate-" + counter_1
            ).value = e.rates),
            (document.getElementById(
              "product-qty-" + counter_1
            ).value = e.quantity),
            (document.getElementById(
              "productPrice-" + counter_1
            ).value = "$" + e.rates * e.quantity),
            counter_1++;
        });
      }, 300),
        (document.getElementById("cart-subtotal").value =
