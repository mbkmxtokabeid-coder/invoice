/**
 * Auto-Save Draft Manager for Ibekami Invoices (Add & Edit)
...
(function ($) {
    ...
    function getStorageKey() {
        ...
        if (invoiceId) {
            return 'ibekami_edit_invoice_draft_' + invoiceId;
        } else {
            return 'ibekami_add_invoice_draft';
        }
    }
    ...
    function restoreDraft() {
        ...
        if (header.select_potongan) {
            ...
            if (header.ptg) {
                $('#input-potongan').val(header.ptg).trigger('input').trigger('change');
            }
        }
        if (header.dp) {
            $('#input-dp').val(header.dp).trigger('input').trigger('change');
        }
    ...
    $(document).ready(function () {
        ...
        if ($submitBtn.length && !$('#btn-reset-draft').length) {
            ...
            $resetBtn.on('click', function () {
                if (typeof Swal !== 'undefined') {
                    ...
                    if (confirm('Apakah Anda yakin ingin mengosongkan draf inputan ini?')) {
                        clearInvoiceDraft();
                        window.location.reload();
                    }
                }
        ...
        $(document).on('click', '.btn-cancel-ibekami', function (e) {
            e.preventDefault();
