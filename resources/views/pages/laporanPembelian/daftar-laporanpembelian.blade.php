  ...
  <div class="page-content">
    ...
    <div class="card-body row g-3">
      ...
      <div class="row col-lg-12 col-sm-6 mt-3">
        <label class="col-lg-2 col-form-label" >Semua Pembelian</label>
        <div class="col-lg-3 input-light mb-4" style="margin-left: -10px; margin-right:-20px;">
          <select name="vendor" class="form-control invoice" >
            <option value="semua"  selected >Semua Vendor </option>
            @foreach ($katVen as $id => $namaVendor)
            <option value="{{$id}}">{{$namaVendor}}</option>
            @endforeach
        </select>
        </div>
   ...
   <div class="card">
    <div class="card-body row g-3">
      ...
      <div class="row col-lg-12 col-sm-6 mt-3">
        ...
        <label class="col-lg-1 col-form-label" style="margin-left: 30px">Vendor</label>
        <div class="col-lg-3 input-light mb-4" style="margin-left: -10px; margin-right:-20px">
          <select class="form-select bg-light invoice" name="vendor" required>
    ...
    <div class="card">
    <div class="card-body row g-3">
      <form action="/invoice/laporanPembelian-export-year" method="POST" target="_blank">
        @csrf
     
      <div class="row col-lg-6 mt-2">
        <h5>Laporan Pembelian Tahunan</h5>
      </div>
      <div class="row col-lg-12 col-sm-6 mt-3">
