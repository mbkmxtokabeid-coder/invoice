        ...
        <div class="row">
          <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0">Tambah Karyawan</h4>
                      ...
                      <div class="row g-3">
                        <div class="row col-lg-12 col-sm-6">
                          ...
                          <div class="col-lg-7 input-light mb-2">
                            <input class="form-control" placeholder="Nama Karyawan" name="namaKaryawan" value="{{old('namaKaryawan')}}" required>
                           </div>
                          </div>
                          {{-- End Input SPB --}}
                        ...
                        <div class="row col-lg-12 col-sm-6">
                          ...
                          <div class="col-lg-7 input-light mb-2">
                            <select type="text" name="role" class="form-select">
                              ...
                              <option value="Stockist" {{ old('role') == 'Stockist' ? 'selected' : '' }}>Stockist</option>
                              <option value="AdminTKB" {{ old('role') == 'AdminTKB' ? 'selected' : '' }}>Admin TKB</option>
                               <option value="AdminTKB" {{ old('role') == 'AdminTKB' ? 'selected' : '' }}>Admin TKB</option>
