  ...
  <div class="container-fluid">
      ...
      <!-- end page title -->
       ...
       <div class="row pb-4 gy-3">
          <div class="col-sm-4">
              <a href="{{ url('addInvoice') }}" class="btn btn-primary addMembers-modal"><i class="las la-plus me-1"></i>Tambah Invoices</a>
          </div>
    ...
    @if($isOwner)
        @if($inv->approval === 'Unlock')
            <li>
                <a class="dropdown-item" href="{{ url('ubah-status-lock/'.$inv->id) }}">
    ...
    @if($canManage)
        <li>
            <a class="dropdown-item" href="{{ url('editInvoice/'.$inv->id.'/edit') }}">
