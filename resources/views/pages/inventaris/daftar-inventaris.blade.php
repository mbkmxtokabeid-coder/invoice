  ...
  <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          <div class="modal-body text-center p-5">
            <input type="hidden" name="inventaris_delete_id" id="inventaris_id">
            <lord-icon
            ...
            <div class="mt-4">
              ...
              <div class="hstack gap-2 justify-content-center">
                  ...
                  <form id="deleteForm" action="/invoice/deleteInventaris" method="POST">
                    @csrf
                    @method('delete')
      ...
      <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Inventaris Kantor</h4>
    ...
    <!-- end page title -->
        ...
        <div class="row pb-2 align-items-end" style="margin-top:-10px;">
          ...
          <div class="col-sm-3" style="margin-right: -150px;">
            <a href="addInventaris" class="btn btn-md btn-primary mt-2">
              <i class="las la-plus"></i>Tambah Inventaris</a>
            </div>
          ...
          <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Daftar Stok Inventaris</h5>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                          @foreach ($inventaris as $inv)
                            ...
                            <tr>
                              ...
                              <td>{{$inv->jenis_inventaris}}</td>
                              <td>{{date('d F Y H:i:s', strtotime($inv->updated_at))}}</td>
                              <td>{{$inv->stok}}</td>
                              <td>{{date('d F Y', strtotime($inv->formattedTglBeli))}}</td>
                                <td>
                                  <div class="dropdown text-center">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="edit-stokInventaris/{{$inv->id}}"><i class="las la-pen fs-18 align-middle me-2 text-muted"></i>
                                                Update Stock</a>
                                        </li>
                                        <li class="dropdown-divider"></li>
                                        <li>
                                            <button class="dropdown-item hapus-btn remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteModal" id="inventaris_id" value="{{$inv->id}}">
...
<script src="{{asset('js/halaman/inventaris.js')}}"></script>
@endsection