    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xxl-9">
          ...
          <div class="card">
            {{-- Start Form --}}
            <form method="POST" action="{{ url('update-spb/' . $spb->id) }}" class="needs-validation" id="spb_form"
              ...
              <div class="card-body p-4">
                  ...
                  <div class="col-lg-8">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="row col-lg-12 col-sm-6">
                        ...
                        <div class="col-lg-7 input-light mb-2">
                          <input class="form-control" type="text" name="customer" id="customer" list="pelanggan"
                            placeholder="Pelanggan" value="{{$spb->customer}}" required>
                      ...
                      <div class="row col-lg-12 col-sm-6">
                        ...
                        <div class="col-lg-7 input-light mb-2">
                          <input class="form-control" type="text" name="perusahaan" value="{{$spb->perusahaan}}"
                            id="usaha" list="usaha" placeholder="Perusahaan" required>
                          <datalist id="usaha">
                      ...
                      <div class="row col-lg-12 col-sm-6">
                        ...
                        <div class="col-lg-7 input-light mb-2">
                          <input type="text" name="no_telp" class="form-control" value="{{$spb->nomor_telepon}}"
                      ...
                      <div class="row col-lg-12 col-sm-6">
                        ...
                        <div class="col-lg-7 input-light mb-2">
                          <input type="text" name="nama_penandatangan" class="form-control" value="{{ old('nama_penandatangan') ?? $spb->nama_penandatangan }}"
                              ...
                              <tr id="{{$index + 1}}" class="product">
                                ...
                                <td class="text-start">
                                  <div class="mb-2">
                                    ...
                                    <select class="form-field @error('barang_id[]') is-invalid @enderror" data-choices
                                      data-choices-sorting="true" id="productName-{{$index + 1}}" name="barang_id[]">
                                  ...
                                  <textarea
                                    ...
                                    placeholder="Deskripsi Item">{{$brg->deskripsi}}</textarea>
                                ...
                                <td>
                                  <select class="form-select bg-light border-0 @error ('satuan[]') is-invalid @enderror"
                                    id="satuan-1" name="satuan[]" value="{{$brg->satuan}}" required>
                                ...
                                <td>
                                  <div class="input-step">
                                    <input type="number" class="text-center @error('qty[]') is-invalid @enderror"
                                      id="product-qty-1" value="{{$brg->qty}}" name="qty[]">
                                  </div>
                                  @error('qty[]')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                  @enderror
                                ...
                                <td class="text-end">
                                  <div>
                                    <textarea id="productKeterangan-1"
                                      ...
                                      name="keterangan[]" cols="2" placeholder="Keterangan">{{$brg->keterangan}}</textarea>
                                    @error('keterangan[]')
                                      <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                  </div>
                ...
                <div class="row">
                  <button type="submit" id="simpan" class="btn btn-primary fw-medium col-lg-3"><i
                      class="ri-save-3-line me-1 align-bottom"></i>Update</button>
                </div>
              </div>
            </form>
            {{-- End Form --}}
