          ...
          <div class="card">
            ...
            <form method="POST" action="{{ url('store-spb') }}" class="needs-validation" id="spb_form">
              ...
              <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                      <div class="row col-lg-12 col-sm-6">
                        ...
                        <div class="col-lg-7 input-light mb-2">
                          ...
                          <select class="form-select bg-light @error('namaSpb') is-invalid @enderror" name="namaSpb"
                            data-choices data-choices-search-false required>
                            <option value="" disabled selected>Pilih Perusahaan</option>
                            @foreach($namaPerusahaan as $usaha)
                              <option value="{{$usaha->id}}" {{ old('namaSpb') == $usaha->id ? 'selected' : '' }}>
                                {{$usaha->nama_perusahaan}}</option>
                            @endforeach
                          </select>
                          @error('namaSpb')
                      ...
                      <div class="row col-lg-12 col-sm-6">
                        ...
                        <div class="col-lg-7 input-light mb-2">
                          <input class="form-control" type="text" name="customer" id="customer" list="pelanggan"
                            placeholder="Pelanggan" value="{{old('customer')}}" required>
                      ...
                      <div class="row col-lg-12 col-sm-6">
                        ...
                        <div class="col-lg-7 input-light mb-2">
                          <input class="form-control" type="text" name="perusahaan" id="usaha" list="usaha"
                            placeholder="Perusahaan" value="{{old('perusahaan')}}" required>
                          <datalist id="usaha">
                    ...
                    <div class="profile-user mx-auto  mb-3">
                      ...
                      <label for="profile-img-file-input" class="d-block" tabindex="0">
                        ...
                        <span
                          ...
                          <img src="{{asset('images/logo-ib-black.png')}}"
                            class="card-logo card-logo-dark user-profile-image img-fluid" alt="logo dark">
                          <img src="{{asset('images/logo-ib-white.png')}}"
                    ...
                    <table class="invoice-table table table-borderless table-nowrap mb-0">
                      <div class="table-responsive">
                          ...
                          <tr id="1" class="product">
                            ...
                            <td class="text-start">
                              <div class="mb-2">
                                ...
                                <select class="form-field @error('barang_id[]') is-invalid @enderror" data-choices
                                  data-choices-sorting="true" id="productName-1" name="barang_id[]">
                              ...
                              @enderror
                              <textarea
                                class="form-control bg-light border-0 @error('deskripsi_item[]') is-invalid @enderror"
                                id="productDetails-1" name="deskripsi_item[]" rows="2"
                                placeholder="Deskripsi Item">{{old('deskripsi_item[]')}}</textarea>
                              @error('deskripsi_item[]')
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                            </td>
                            <td>
                              <select class="form-select bg-light border-0 @error ('satuan[]') is-invalid @enderror"
                                id="satuan-1" name="satuan[]" required>
                            ...
                            <td>
                              <div class="input-step">
                                <input type="number" class="text-center @error('qty[]') is-invalid @enderror"
                                  id="product-qty-1" value="{{ old('qty[]') ? old('qty[]') : 0 }}" name="qty[]">
                              </div>
                              @error('qty[]')
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                            ...
                            <td class="text-end">
                              <div>
                                <textarea id="productKeterangan-1"
                                  class="form-control bg-light border-0 @error('keterangan[]') is-invalid @enderror"
                                  name="keterangan[]" cols="2" placeholder="Keterangan">{{old('keterangan[]')}}</textarea>
                                @error('keterangan[]')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                              </div>
                        ...
                        <tbody id="newlink">
                          <tr id="1" class="product">
                            ...
                            <td class="text-start">
                              <div class="mb-2">
                                ...
                                <select class="form-field @error('barang_id[]') is-invalid @enderror" data-choices
                                  ...
                                  <option value="" selected disabled>Pilih Item</option>
                                  @foreach ($barang as $item)
                                    <option value="{{ $item->id }}" {{ old('barang_id.0') == $item->id ? 'selected' : '' }}>
                              ...
                              <textarea
                                class="form-control bg-light border-0 @error('deskripsi_item[]') is-invalid @enderror"
                                id="productDetails-1" name="deskripsi_item[]" rows="2"
                                placeholder="Deskripsi Item">{{ old('deskripsi_item.0') }}</textarea>
                              @error('deskripsi_item[]')
                                <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                            </td>
                            ...
                            <td>
                              <div class="input-step">
                                <input type="number" class="text-center @error('qty[]') is-invalid @enderror"
                                  id="product-qty-1" value="{{ old('qty.0') ? old('qty.0') : 0 }}" name="qty[]">
                              </div>
                              @error('qty[]')
                                <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                            ...
                            <td class="text-end">
                              <div>
                                <textarea id="productKeterangan-1"
                                  class="form-control bg-light border-0 @error('keterangan[]') is-invalid @enderror"
                                  name="keterangan[]" cols="2"
                                  placeholder="Keterangan">{{ old('keterangan.0') }}</textarea>
                                @error('keterangan[]')
                                  <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                              </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colspan="5"><a href="javascript:new_link()" id="add-item"
                                class="btn btn-soft-secondary fw-medium"><i class="ri-add-fill me-1 align-bottom"></i> Add
                                Item</a>
                            </td>
                          </tr>
                        </tbody>
                ...
                {{-- End Row 2 --}}
                <div class="row">
                  <button type="submit" id="simpan" class="btn btn-primary fw-medium col-lg-3"><i
                      class="ri-save-3-line me-1 align-bottom"></i>Simpan</button>
                </div>
              </div>
            </form>
            {{-- End Form --}}
