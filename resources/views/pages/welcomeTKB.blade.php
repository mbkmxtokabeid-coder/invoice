            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Dashboard Tokabe</h4>
                                ...
                                <div class="card-body py-1">
                                    <div class="row gy-2">
                                        ...
                                        <div class="col-md-4">
                                            <h4 class="fs-22 mb-0">
                                                Rp. {{$jumlahPerTahun}}
                                                <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Year Incomes</span></h4>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="d-flex main-chart justify-content-end">
                                                ...
                                                <!--        Rp. {{$jumlahPerBulan}}-->
                                                <!--        <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Monthly Incomes</span></h4>-->
                                                <!--</div>-->
                                            </div>
                                        </div>
                                        @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex main-chart justify-content-end">
                                                <div class="ps-4">
                                                    <h4 class="text-primary fs-22 mb-0">
                                                        Rp. {{$jumlahBBPerBulan}}
                                                        <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Monthly Outstanding</span></h4>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body py-1">
                                    <div class="row gy-2">
                                        ...
                                        <div class="col-md-4">
                                            <h4 class="fs-22 mb-0">
                                                Rp. {{$jumlahPerTahunPO}}
                                                <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Year PO</span></h4>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="d-flex main-chart justify-content-end">
                                                <div class="px-4 border-end">
                                                    <h4 class="text-primary fs-22 mb-0" id="jumlahPO">Rp.
                                                        {{$jumlahPerBulan}}
                                                        <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">PO</span></h4>
                                                </div>
                                                <div class="ps-4">
                                                    <h4 class="text-primary fs-22 mb-0">
                                                        Rp. {{$jumlahPerBulanPO}}<span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Monthly PO</span></h4>
                                                </div>
                                            </div>
                                        </div>
                                        @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex main-chart justify-content-end">
                                                <div class="ps-4">
                                                    <h4 class="text-primary fs-22 mb-0">
                                                        Rp. {{$jumlahBBPerBulanPO}}
                                                        <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Monthly Outstanding PO</span></h4>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-striped table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                              @foreach ($invoicePO as $invoice)
                                                <tr>
                                                 <td>
                                                    <p class="text-body align-middle">
                                                        {{$invoice->customer}}
                                                    </p>
                                                 </td>
                                                 <td>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="flex-shrink-0 ms-2">
                                            <div class="dropdown">
                                                <a class="text-reset" href="" data-bs-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    <span class="fw-semibold text-uppercase fs-14">Sort By:</span> <span
                                                        class="text-muted" id="periodePO"><i class="las la-angle-down fs-12 ms-2"></i></span>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    @if (auth()->user()->role === 'Pemilik')
                                                    <a class="dropdown-item" href="#" onclick="timeRangePO('year')">Yearly</a>
                                                    <a class="dropdown-item" href="#" onclick="timeRangePO('week')">Weekly</a>
                                                    @endif
                                                    <a class="dropdown-item" href="#" onclick="timeRangePO('month')">Monthly</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> --}}

                                    {{-- <div id="structure_widget_po" data-colors='["--in-primary", "--in-primary-rgb, 0.7", "--in-light"]' class="apex-charts" dir="ltr"></div> --}}
                                    ...
                                    {{-- <div class="px-2">
                                        <div class="structure-list d-flex justify-content-between border-bottom">
                                            <p class="mb-0"><i class="las la-dot-circle fs-18 text-primary me-2"></i>Terbayar</p>
                                            <div>
                                                <span class="pe-2 pe-sm-5" id="terbayarPO"></span>
                                                <span class="badge" id="persenTerbayarPO"> </span>
                                            </div>
                                        </div>
                                        <div class="structure-list d-flex justify-content-between border-bottom">
                                            <p class="mb-0"><i class="las la-dot-circle fs-18 text-primary me-2"></i>Belum Bayar</p>
                                            <div>
                                                <span class="pe-2 pe-sm-5" id="belumTerbayarPO"></span>
                                                <span class="badge" id="persenBlmTerbayarPO"> </span>
                                            </div>
                                        </div>
                                        <div class="structure-list d-flex justify-content-between pb-0">
                                            <p class="mb-0"><i class="las la-dot-circle fs-18 text-primary me-2"></i>Batal</p>
                                            <div>
                                                <span class="pe-2 pe-sm-5" id="batalPO"></span>
                                                <span class="badge" id="persenBatalPO"> </span>
                                            </div>
                                        </div>
                                    </div> --}}
{{--
