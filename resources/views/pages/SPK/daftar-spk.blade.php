                        ...
                        <td>
                          <div class="dropdown text-center">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <button data-bs-toggle="modal" data-bs-target="bs-example-modal-center" class="dropdown-item hapus-btn" value="{{$surat->id}}" >
...
<script src="{{asset('js/halaman/spk.js')}}"></script>
